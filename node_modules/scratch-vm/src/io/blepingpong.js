...
const ScratchLinkWebSocket = 'wss://localhost:20110/scratch/blepingpong';
//const ScratchLinkWebSocket = 'wss://device-manager.scratch.mit.edu:20110/scratch/blepingpong';
//const ScratchLinkWebSocket = 'wss://device-manager.scratch.mit.edu:8181/scratch/blepingpong';
//const ScratchLinkWebSocket = 'wss://device-manager.scratch.mit.edu:8181/scratch/blepingpong';


// const log = require('../util/log');

class BLEPINGPONG extends JSONRPCWebSocket {
    ...
    requestPeripheral () {
        if (this._ws.readyState === 1) { // is this needed since it's only called on ws.onopen?
            ...
            this._discoverTimeoutID = window.setTimeout(this._handleDiscoverTimeout.bind(this), 150000);
    ...
    connectPeripheral(id) {
        ...
        if (this._connectCount1) {
            this.sendRemoteRequest('connect', { peripheralId: id , Solo: 1})
                .then(() => {
                    console.log("connectPeripheral id success!");
                ...
                .catch(e => {
                    console.log("connectPeripheral id error! " + e);
                    // this._handleRequestError(e);
                });
        }
        else {
    ...
    didReceiveCall (method, params) {
        ...
        switch (method) {
            case 'didDiscoverPeripheral':
                ...
                this.connectPeripheral(params.peripheralId);
    ...
    handleDisconnectError (/* e */) {
        // log.error(`BLEPINGPONG error: ${JSON.stringify(e)}`);
