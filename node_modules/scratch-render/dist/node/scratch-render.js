...
var TextBubbleSkin = __webpack_require__(24);
...
var Skin = __webpack_require__(3);
var SVGMIP = __webpack_require__(22);
var SvgRenderer = __webpack_require__(23).SVGRenderer;
    ...
    _createClass(SVGSkin, [{
        ...
        value: function dispose() {
            if (this._texture) {
                ...
                try {
                    for (var _iterator = this._scaledMIPs[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
                        var mip = _step.value;
        ...
        key: 'createMIP',
        value: function createMIP(scale, resetCallback) {
            var _this2 = this;

            var textureCallback = function textureCallback(textureData) {
                if (resetCallback) resetCallback();
                // Check if we have the largest MIP
                // eslint-disable-next-line no-use-before-define
                if (!_this2._scaledMIPs.length || _this2._scaledMIPs[_this2._scaledMIPs.length - 1]._scale <= scale) {
                    // Currently silhouette only gets scaled up
                    _this2._silhouette.update(textureData);
                }
            };
            var mip = new SVGMIP(this._renderer, this._svgRenderer, scale, textureCallback);
        ...
        * @fires Skin.event:WasAltered
        ...
        key: 'resetMIPs',
        value: function resetMIPs(mip, rotationCenter) {
            this._scaledMIPs.forEach(function (oldMIP) {
                return oldMIP.dispose();
            });
            this._scaledMIPs.length = 0;
        ...
        value: function setSVG(svgData, rotationCenter) {
            ...
            if (!this._svgRenderer.canvas.width || !this._svgRenderer.canvas.height) {
                _get(SVGSkin.prototype.__proto__ || Object.getPrototypeOf(SVGSkin.prototype), 'setEmptyImageData', this).call(this);
                return;
            }

            var maxDimension = Math.ceil(Math.max(this.size[0], this.size[1]));
            var testScale = 2;
            ...
            var textureScale = 1;
            var mip = this.createMIP(textureScale, function () {
                return _this3.resetMIPs(mip, rotationCenter);
            });
        }
    }, {
        key: 'size',
...
var SVGMIP = function () {
    ...
    * @constructor
    */
    function SVGMIP(renderer, svgRenderer, scale, callback) {
        _classCallCheck(this, SVGMIP);
    ...
    _createClass(SVGMIP, [{
        ...
        value: function draw() {
            ...
            this._svgRenderer._draw(this._scale, function () {
                var textureData = _this._getTextureData();
                var textureOptions = {
                    auto: false,
                    wrap: _this._renderer.gl.CLAMP_TO_EDGE,
                    src: textureData
                };

                _this._texture = twgl.createTexture(_this._renderer.gl, textureOptions);
                _this._callback(textureData);
            });
        }
    }, {
        key: 'dispose',
        ...
        key: '_getTextureData',
        value: function _getTextureData() {
...
var CanvasMeasurementProvider = __webpack_require__(28);
var Skin = __webpack_require__(3);
...
var minilog = __webpack_require__(30);
minilog.enable();
...
var consoleLogger = __webpack_require__(33);
...
e.formatClean = new (__webpack_require__(34));
e.formatColor = new (__webpack_require__(35));
e.formatNpm = new (__webpack_require__(36));
e.formatLearnboost = new (__webpack_require__(37));
e.formatMinilog = new (__webpack_require__(38));
e.formatWithStack = new (__webpack_require__(39));
e.formatTime = new (__webpack_require__(40));
...
logger.color = __webpack_require__(42);
logger.minilog = __webpack_require__(43);
